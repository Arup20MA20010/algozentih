...
void solve()
{
    // to find the solution of a,b,c,d,e,f,g,h,i,j such that abcde/fghij =n and all a,b,c,d,e,f,g,h,i,j are distinct and mapped to the digits
    int n;
    cin >> n;
