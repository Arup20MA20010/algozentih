...
void solve()
{
    ...
    sort(left_, left_ + n);
    sort(right_, right_ + n);
    cin >> q;
    while (q--)
    {
        cin >> y;
        // no .of elements in left greater than y
        // ub - no. of elements <= y
        int left_count = n + left_ - upper_bound(left_, left_ + n, y);
        // no of elements in right less than y
        int right_count = lower_bound(right_, right_ + n, y) - right_;
        cout << n - right_count - left_count << nline;
    }
}
int main()
{
